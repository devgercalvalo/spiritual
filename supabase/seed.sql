...
insert into public.products (id, name, slug, description, mercado_libre_url, price_display, is_active) values
  ('00000000-0000-4000-8000-000000000201', 'Veladora blanca de protección', 'veladora-blanca-de-proteccion', 'Veladora artesanal para rituales de protección.', 'https://articulo.mercadolibre.com.mx/', '$89 MXN', true),
  ('00000000-0000-4000-8000-000000000202', 'Incienso de canela', 'incienso-de-canela', 'Incienso natural de canela para atraer abundancia.', 'https://articulo.mercadolibre.com.mx/', '$65 MXN', true);

insert into public.kits (id, name, slug, description, is_active) values
  ('00000000-0000-4000-8000-000000000301', 'Kit de abundancia', 'kit-de-abundancia', 'Todo lo necesario para el ritual de abundancia: veladora, incienso y más.', true);
