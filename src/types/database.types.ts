...
// Alias de conveniencia usados en el resto de la app. Los campos de estado son
// `text` con CHECK constraint en Postgres (no un enum nativo), así que
// `supabase gen types` los tipa como `string`; aquí los angostamos a los
// valores reales para tener autocompletado/chequeo estricto en el código.
...
export type Post = Omit<PublicTables["posts"]["Row"], "status"> & {
  status: "draft" | "published"
}
export type Comment = Omit<PublicTables["comments"]["Row"], "status"> & {
